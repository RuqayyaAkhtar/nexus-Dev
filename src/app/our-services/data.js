...
import processImage1 from './architectImages/image 64.png'
          ...
          card: [
            {
              ...
              images: [sliderImage8, sliderImage8], // or any images you want in the slider
            },
            {
              text:[
                {
              ...
              images: [sliderImage9, sliderImage9],
            },
            {
              text:[
                {
              ...
              images: [sliderImage10,sliderImage10],
            },
            {
              text:[
                {
              ...
              images: [sliderImage11, sliderImage11],
            },
            {
              text:[
                {
              ...
              images: [sliderImage12,sliderImage12],
            },
          ]
        },
