...
import sliderImageA1 from './bussinessAnalyst/business-team-talking_265022-72584 (1).png'
import sliderImageA2 from './bussinessAnalyst/business-team-office_1265500-96116 (1).png'
import sliderImageA3 from './bussinessAnalyst/image 136 (1).png'
import sliderImageA4 from './bussinessAnalyst/image 126 (1).png'
import sliderImageA5 from './bussinessAnalyst/image 137 (1).png'
// .......
...
import  bannerImageC from './bussinessConsultnt/Group 1197132657.png'
import  sectionImageC from './bussinessConsultnt/image 55.png'
import  sliderImageC1 from './bussinessConsultnt/Frame 1000004282 (7).png'
import  sliderImageC2 from './bussinessConsultnt/Frame 1000004282 (8).png'
import  sliderImageC3 from './bussinessConsultnt/Frame 1000004282 (9).png'
import  sliderImageC4 from './bussinessConsultnt/Frame 1000004282 (10).png'
import  sliderImageC5 from './bussinessConsultnt/Frame 1000004282 (11).png'
import  sliderImageC6 from './bussinessConsultnt/Frame 1000004282 (12).png'
import  sliderImageC7 from './bussinessConsultnt/Frame 1000004282 (13).png'
import processImageC1 from './bussinessConsultnt/Group 1197132447.png'
// ........UI/UX.............................................................
import  bannerImageU from './ui-uxImages/image 104.png'
import  sectionImageU from './ui-uxImages/Group 1197132612.png'
import  sliderImageU1 from './ui-uxImages/image 81.png'
import  sliderImageU2 from './ui-uxImages/image 123.png'
...
import  sliderImageD1 from './digitalMarketing/Frame 1000004282.png'
import  sliderImageD2 from './digitalMarketing/Group 1197132602.png'
import  sliderImageD3 from './digitalMarketing/Frame 1000004282 (1).png'
import  sliderImageD4 from './digitalMarketing/Frame 1000004282 (2).png'
import  sliderImageD5 from './digitalMarketing/Frame 1000004282 (3).png'
      ...
      banner: [
        {
          ...
          para1: "Seamless Designs, Exceptional Experiences with Nexus UI/UX Services",
          para2: "We craft intuitive and visually stunning interfaces that prioritize user satisfaction and drive business success.",
          date: "Latest update on 12 sep, 2024",
          image: bannerImageA
        },
      ],
          ...
          card: [
            {
              ...
              images: [sliderImageA1, sliderImageA2],
            },
            {
              text:[
                {
              ...
              images: [sliderImageA2, sliderImageA3],
            },
            {
              text:[
                {
              ...
              images: [sliderImageA3,sliderImageA4],
            },
            {
              text:[
                {
                  title: "Software & System Implementation",
                  bulletPoints: [
                    "Design the backbone infrastructure, including servers, networks, and storage.",
                     "Plan for disaster recovery and high availability." ,
                     "Optimize infrastructure for scalability and performance. ",
              ...
              images: [sliderImageA4, sliderImageA5],
            },
            {
              text:[
                {
              ...
              images: [sliderImageA5,sliderImageA1],
            },
          ]
        },
    ...
    banner: [
      {
        ...
        para1: "Driving Business Transformation with Expert Consulting",
        para2: "At Nexus, we build scalable, effiAt Nexus, we bridge strategy and technology to architect solutions that accelerate growth.cient, and future-ready systems tailored to your needs.",
        date: "Latest update on 12 sep, 2024",
        image: bannerImageC
      },
    ],
        ...
        card: [
          {
            ...
            images: [sliderImageC1, sliderImageC2], 
          },
          {
            text:[
              {
            ...
            images: [sliderImageC2, sliderImageC1],
          },
          {
            text:[
              {
            ...
            images: [sliderImageC3,sliderImageC2],
          },
          {
            text:[
              {
            ...
            images: [sliderImageC4, sliderImageC2],
          },
          {
            text:[
              {
            ...
            images: [sliderImageC5,sliderImageC2],
          },
          {
              text:[
              {
            ...
            images: [sliderImageC6,sliderImageC3],
          },
          {
              text:[
              {
            ...
            images: [sliderImageC7,sliderImageC1],
          },
    ...
    section1: [
      {
        ...
        para: "Welcome to our UI/UX Design Services page! At our agency, we specialize in crafting seamless, user-centric designs that enhance the user experience and elevate the digital presence of your brand. Whether you're launching a website, mobile app, or software platform, our team of experienced UI/UX designers focuses on creating intuitive, visually stunning interfaces that engage users and foster long-term loyalty. With a deep understanding of design principles and human behavior, we work closely with you to deliver design solutions that meet both your business goals and user needs.",
        image: sectionImageU
      },
    ],
        ...
        card: [
          {
            ...
            images: [sliderImageU1, sliderImageU2], 
          },
          {
            text:[
              {
            ...
            images: [sliderImageU2, sliderImageU3],
          },
          {
            text:[
              {
            ...
            images: [sliderImageU3,sliderImageU4],
          },
          {
            text:[
              {
            ...
            images: [sliderImageU4,sliderImageU5],
          },
          {
            text:[
              {
            ...
            images: [sliderImageU5,sliderImageU1],
          },
        ]
      },
...
// ...........

  {
    ...
    banner: [
      {
        ...
        para1: "Boost Your Brand Visibility and Drive Results with Nexus Digital Marketing",
        para2: "From strategy to execution, we help businesses grow online with tailored digital marketing solutions designed for success.",
        date: "Latest update on 12 sep, 2024",
        image: bannerImageD
      },
    ],
    section1: [
      {
        heading: 'Digital Marketing',
        para: "Digital Marketing is the strategic use of online platforms, tools, and techniques to promote products, services, or brands, connecting businesses with their target audience in the digital space. It includes services like SEO, social media marketing, PPC advertising, content creation, and email campaigns to drive traffic, generate leads, and boost conversions. By leveraging data-driven strategies and modern technologies, digital marketing ensures measurable growth and long-term success in today’s competitive online landscape.",
        image: sectionImageD
      },
    ],
    work: [
    ...
    cards: [
      {
        heading1: "Services of a Digital Marketing",
        description1: "Here’s a comprehensive guide to designing a webpage for Web Development Services offered by your agency, Nexus. The page will include the services provided, the roles involved, tools used, and the deliverables for your clients.",
      },
      {
        card: [
          {
            text: [
              {
                ...
                bulletPoints: [
                  "On-page SEO: Involves optimizing individual web pages to rank higher and attract more relevant traffic from search engines.",
                  " Implementing best practices to reduce load times and enhance website speed.",
                  "Testing and ensuring functionality across multiple browsers like Chrome, Firefox, Safari, and Edge.",
                  "Establish architecture governance frameworks.",
                ],
            ...
            images: [sliderImageD1, sliderImageD2],
          },
          {
            text:[
              {
            ...
            images: [sliderImageD2, sliderImageD3],
          },
          {
            text:[
              {
            ...
            images: [sliderImageD3,sliderImageD4],
          },
          {
            text:[
              {
                title: "Web Analytics and Insights",
                bulletPoints: [
                  "Design the backbone infrastructure, including servers, networks, and storage.",
                   "Plan for disaster recovery and high availability." ,
                   "Optimize infrastructure for scalability and performance. ",
            ...
            images: [sliderImageD4, sliderImageD5],
          },
          {
            text:[
              {
            ...
            images: [sliderImageD5,sliderImageD1],
          },
        ]
      },
  ...
  {
    id: 1,
    title: "Stunning Designs Aligned with Your Brand:",
    description: " A clear, actionable business strategy aligned with your long-term goals, market opportunities, and available resources.",
    icon: maskImage,
  },
  {
    id: 2,
