...
const sliderData = [
  ...
  },
  {
    ...
    description: `We revamped an online store to create a seamless shopping experience. By implementing advanced filtering options, dynamic product recommendations, and an optimized checkout process, we helped increase conversion rates and overall sales.`,
    client: "E-Shop",
    country: "Canada",
    industry: "E-Commerce",
    image: image2,
  },
  {
    ...
    description: `Our team developed a custom mobile app to provide users with a personalized experience. This app includes features like push notifications, real-time updates, and offline access, resulting in enhanced user engagement.`,
    client: "Mobile Tech",
    country: "UK",
